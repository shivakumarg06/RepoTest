...
$ArchivedFolders = "$sourceDir\drop"
$workDir = "C:\verimoto"
...
Copy-Item "$workDir\UnZipped\Content\C_C\VSTSAgent\vsts-agent-win-x64-2.147.1\_work\1\s\Verimoto\*" -Destination "$workDir" -Recurse -Force
